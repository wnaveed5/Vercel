          ...
          <div className="grid md:grid-cols-2 gap-8 items-center bg-gradient-to-r from-sky-50 to-white rounded-2xl p-8">
            <div className="space-y-6">
              ...
              <div className="space-y-3">
                ...
                <p>Discover expert-led training programs in Houston. <a href="/houston-childcare-training">Learn more about Texas Childcare Training in Houston</a>.</p>
</div>
                <div className="flex items-center gap-2 text-gray-600">
            ...
            <div className="relative h-[400px] order-first md:order-last">
              <Image
