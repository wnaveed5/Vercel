          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              ...
              <p className="text-xl text-gray-600">
                Get certified with BlueSky TD's comprehensive childcare training programs, approved by TECPDS. Serving
                Sugar Land, Houston, and surrounding areas.
              </p>
              <div className="flex flex-wrap gap-4">
                <Button size="lg" asChild>
                  <Link href="/seminars">Explore Texas Programs</Link>
                </Button>
            ...
            {[
              {
                ...
                description: "All courses meet TECPDS requirements",
              },
              {
